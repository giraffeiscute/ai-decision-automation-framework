...
if __name__ == "__main__":
    ...
    # 輸入資料夾
    input_folder = 'results_nn_20250415/'
    ...
    for dist in dist_list:
        ...
        for loc_num in loc_num_list:
            ...
            ##%% 儲存 IP-SHAP 結果
            output_name = f'result_nn_R+_20251013/shap/deploy_decision_survivalrate_{loc_num}_set_{build_num_choose_cnt}_dist_{dist}.npy'
            np.save(output_name, deploy_decision_survivalrate_shap)
            
            output_name = f'result_nn_R+_20251013/shap/deploy_decision_survivalrate_average_{loc_num}_set_{build_num_choose_cnt}_dist_{dist}.npy'
            np.save(output_name, deploy_decision_survivalrate_average_shap)
            
            output_name = f'result_nn_R+_20251013/shap/deploy_decision_survivalrate_nonzero_average_{loc_num}_set_{build_num_choose_cnt}_dist_{dist}.npy'
            np.save(output_name, deploy_decision_survivalrate_nonzero_average_shap)

            ##%% 儲存 IP-MLP 結果
            output_name = f'result_nn_R+_20251013/mlp/deploy_decision_survivalrate_{loc_num}_set_{build_num_choose_cnt}_dist_{dist}.npy'
            np.save(output_name, deploy_decision_survivalrate_mlp)
            
            output_name = f'result_nn_R+_20251013/mlp/deploy_decision_survivalrate_average_{loc_num}_set_{build_num_choose_cnt}_dist_{dist}.npy'
            np.save(output_name, deploy_decision_survivalrate_average_mlp)
            
            output_name = f'result_nn_R+_20251013/mlp/deploy_decision_survivalrate_nonzero_average_{loc_num}_set_{build_num_choose_cnt}_dist_{dist}.npy'
